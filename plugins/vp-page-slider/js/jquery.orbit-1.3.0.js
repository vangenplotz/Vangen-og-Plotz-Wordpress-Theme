...
(function($) {
  ...
  var ORBIT = {
    ...
    directionalNavHTML: '<div class="slider-nav"><span class="left"><a class="nav-icon">Forrige</a></span><span class="right"><a class="nav-icon">Neste</a></span></div>',
    ...
    rotateTimer: function () {
      ...
      if(this.degrees > 180) {
		this.$timer.addClass('move');
        this.$rotator.addClass('move');
        this.$mask.addClass('move');
      }
      if(this.degrees > 360) {
		this.$timer.removeClass('move');
      ...
      if (!this.locked) {
        ...
        if (this.options.animation == "horizontal-push") {
          if (slideDirection == "next") {
            ...
            this.$slides
              .eq(this.prevActiveSlide)
              .animate({"left" : -this.orbitWidth, "opacity" : 0}, this.options.animationSpeed);
          }
          if (slideDirection == "prev") {
            this.$slides
              .eq(this.activeSlide)
